...
| [Migração forge-agent 1.0 → 2.0](./MIGRATION.md) | Convertendo o `.gsd/` de um projeto forge-agent 1.0 para o Forge 2.0, com backup automático e coexistência com o 1.0 |
