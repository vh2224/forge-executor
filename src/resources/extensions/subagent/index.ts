...
import { loadEffectiveGSDPreferences } from "../shared/compat/preferences.js";
import { emitJournalEvent } from "../shared/compat/journal.js";
	...
	pi.registerTool({
		...
		async execute(_toolCallId, params, signal, onUpdate, ctx) {
			...
			const cmuxClient = CmuxClient.fromPreferences(
				loadEffectiveGSDPreferences()?.preferences as Parameters<typeof CmuxClient.fromPreferences>[0],
			);
