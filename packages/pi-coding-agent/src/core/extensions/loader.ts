...
function getAliases(): Record<string, string> {
	...
	// Subpath aliases MUST precede/accompany the bare-package alias: jiti's
	// alias matching maps the PREFIX to a FILE, so a subpath import like
	// `@gsd/pi-coding-agent/core/model-resolver.js` would otherwise resolve to
	// the nonsense `<...>/dist/index.js/core/model-resolver.js` (seen live
	// 2026-07-13: forge extension failed to load and /forge vanished). Same
	// pattern as the existing `@gsd/pi-ai/oauth` entry.
	const piCodingAgentDist = path.resolve(__dirname, "../..");
	_aliases = {
		"@gsd/pi-coding-agent/core/model-resolver.js": path.join(piCodingAgentDist, "core", "model-resolver.js"),
		"@gsd/pi-coding-agent/core/auth-storage.js": path.join(piCodingAgentDist, "core", "auth-storage.js"),
		"@gsd/pi-coding-agent/config.js": path.join(piCodingAgentDist, "config.js"),
