...
import { exportFromFile } from "@forge/agent-core";
import { makeSkillsShadowOverride } from "@forge/agent-core/skills-shadow.js";
...
import { type CreateAgentSessionOptions, createAgentSession } from "@forge/agent-core";
...
export async function main(args: string[]) {
	...
	const resourceLoader = new DefaultResourceLoader({
		...
		skillsOverride: makeSkillsShadowOverride({ cwd, gsdHome: dirname(agentDir) }),
