...
import { CONFIG_DIR_NAME } from "@gsd/pi-coding-agent/config.js";
import type { PathMetadata, ResolvedPaths, ResolvedResource } from "@gsd/pi-coding-agent/core/package-manager.js";
import type { PackageSource, SettingsManager } from "@gsd/pi-coding-agent/core/settings-manager.js";
