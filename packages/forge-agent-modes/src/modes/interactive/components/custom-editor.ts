// gsd-pi + packages/pi-coding-agent/src/modes/interactive/components/custom-editor.ts - App-level editor key handling.
...
import type { AppAction, KeybindingsManager } from "@forge/agent-core";
...
export class CustomEditor extends Editor {
	...
	/** GSD compat alias for filesystem image paste handlers. */
